...
The model includes 16 regional indicators ($\text{region}_{ki}$) with Vancouver-Squamish serving as the reference category. The coefficient $\beta_{3k}$ represents the region-specific effect of the Vancouver Area Deprivation Index (VanDIX), capturing how the relationship between deprivation and injury crashes varies by region.
