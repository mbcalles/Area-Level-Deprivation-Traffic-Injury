...
bc_boundary <- st_read(
  "C:/Users/micha/Documents/GitHub/Area-Level-Deprivation-Traffic-Injury/Processed Data/da_v4_2021b.gpkg"
) %>% 
  st_union()
...
ggsave(
  device = "svg",
  filename = "C:/Users/micha/Documents/GitHub/Area-Level-Deprivation-Traffic-Injury/Figures/figure_1_study_area.svg",
  plot = study_area,
  units = "mm",
  height = 140*1.1,
  width = 190*1.1,
...
ggsave(
  filename = "C:/Users/micha/Documents/GitHub/Area-Level-Deprivation-Traffic-Injury/Figures/figure_1_study_area.jpg",
  plot = study_area,
  units = "mm",
  height = 140*1.1,
  width = 190*1.1,
...
all_modes <- bind_rows(all_irr,cyclist_irr,pedestrian_irr) %>% 
  ...
  labs(y = "Incidence Rate Ratio (95% Credible Interval)",
       x = "Region",
       title = "Association Between Deprivation and Motor Vehicle Crashes in British Columbia (2019-2023)",
       subtitle = "Crashes Involving All Road Users, Cyclists, and Pedestrians By Region",
       color = "Model") +
  scale_color_ipsum() +
  theme_ipsum_es(plot_title_size = 12,subtitle_size = 10,
  ...
  theme(axis.title.x = element_text(size = 10),
        ...
        legend.position = "bottom",
        # Remove whitespace between facets
        panel.spacing = unit(0.5, "lines"),
        # Reduce plot margins
        plot.margin = margin(5, 5, 5, 5),
        # Reduce space around the facet strips
        strip.text = element_text(margin = margin(2, 2, 2, 2))
  ) + 
  coord_flip()

ggsave(device = "jpg",
  filename = "C:/Users/micha/Documents/GitHub/Area-Level-Deprivation-Traffic-Injury/Figures/vandix_injury_irr_forest_plot.jpg",
  plot = all_modes,
  units = "mm",
  height = 190*1.25,
  width = 190*1.25,
