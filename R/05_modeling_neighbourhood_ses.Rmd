...
Spatial autocorrelation analysis showed that all types of casualty claims were spatially clustered. Cyclist casualty claims had the highest spatial dependence (Moran's I = 0.386, pseduo p-value = 0.001), followed by pedestrian casualty claims (Moran's I = 0.308, pseduo p-value = 0.001) and all casualty claims (Moran's I = 0.245, pseduo p-value = 0.001). 
